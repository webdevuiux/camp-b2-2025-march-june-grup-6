...
const LocationAndTime = ({ data, onChange }) => {
  ...
  return (
    <div className="p-4 sm:p-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
          ...
          <div className="flex-1 space-y-4">
            ...
            <div>
              ...
              <select
                className="w-full border border-black rounded px-3 py-2 bg-[#E8DCCF] text-sm sm:text-base"
          ...
          <div className="flex-1">
            <div className="w-full h-[200px] sm:h-[300px] rounded overflow-hidden border relative">
              <iframe
                title="Map"
      ...
      {/* === TIME SECTION === */}
      <div>
        <h3 className="text-lg sm:text-xl font-semibold mb-1">Time</h3>
        <p className="text-xs sm:text-sm text-gray-600 mb-4">
