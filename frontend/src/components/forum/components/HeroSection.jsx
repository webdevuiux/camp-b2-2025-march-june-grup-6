...
const HeroSection = () => {
  return (
    <div className="relative w-full h-68 overflow-hidden mt-8 mb-6 shadow-lg max-md:h-48 max-md:mt-4 max-md:mb-3">
      <img
        ...
        onError={(e) => {
          ...
          e.target.src =
            "https://placehold.co/1000x192/333/fff?text=Forum+Banner";
        }}
      />
