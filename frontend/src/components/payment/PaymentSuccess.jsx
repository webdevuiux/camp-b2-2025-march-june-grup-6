...
const PaymentSuccess = () => {
  ...
  const { state } = useLocation(); // Tambahkan useLocation untuk akses state
      ...
      <div className="w-full max-w-2xl mx-auto text-center">
        ...
        <div className="mb-10">
          ...
          <div className="text-lg text-gray-700 leading-relaxed space-y-2">
            <p>Your ticket has been payment successfully!</p>
            <p>
              {state?.message ||
                "Please contact to 0987654321 on WhatsApp to confirm your order."}
              <br />
              Please check your profile to see your ticket.
            </p>
          </div>
        </div>
